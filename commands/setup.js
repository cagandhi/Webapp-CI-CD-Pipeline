...
async function run(privateKey, gh_user, gh_pass) {
    ...
    // if either of gh_user and gh_pass value is present
    if(gh_user || gh_pass) {

        // if both gh_user and gh_pass is present, run the credential storing shell file
        if(gh_user && gh_pass) {
        ...
        // if either of gh_user or gh_pass is not passed in CLI, display error and exit
        else {
